...
from NoInterNet_PBf_training import *

device = 'cuda' if torch.cuda.is_available() else 'cpu'

def read_terminal():
    desc = 'Hyper-parameter optimization of NoInterNet_fraction_compress for PB inputs'
...
def objective(trial):
    ...
    n_min = trial.suggest_categorical("n_min", [2, 4, 8, 16, 32, 64, 128,256])
    neurons = trial.suggest_categorical("neurons", [32, 64, 128, 256, 512, 1024, 2048])
    n_out = trial.suggest_categorical("n_out", [2, 4, 8, 16, 32, 64, 128, 256])
